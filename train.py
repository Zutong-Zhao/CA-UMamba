...
parser.add_argument("--max_epochs", type=int, default=450, help="maximum epoch number to train")
...
parser.add_argument(
    "--module",default="networks.MA_TransUnet.myFormer", help="The module that you want to load as the network, e.g. networks.MA_TransUnet.myFormer"
)
...
if __name__ == "__main__":
    ...
    # print("参数数量：{:.2f} M".format(params_in_millions))
