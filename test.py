...
from networks.CA_UMamba import myFormer

from utils import test_single_volume
#from utils_vis import test_single_volume
...
if __name__ == "__main__":
    ...
    if not os.path.exists(snapshot):
        # snapshot = snapshot.replace("best_model", "transfilm_epoch_" + str(args.max_epochs - 1))#synapse_epoch_399
